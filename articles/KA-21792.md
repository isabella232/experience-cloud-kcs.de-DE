...
<br>Anwenden von Modi `ALL_OR_EMPTY/ALL` und *null* values<br>
...
<br>Anwenden von Modi: `INSTANCES`, `_instances: 0` und *null* values<br>
...
<br>Verbesserungen, die sich auf Kunden mit `ft-sites-97` enabled<br>
...
<br>Null-Handhabung mit Bedingungen, die auf Ungleichheit prüfen<br>
...
<br>Filteroperator `NOT_AT` mit Datums-/Uhrzeitwerten<br>
...
<br>Arrays: `INSTANCES` mit `_instances: 0` nicht ordnungsgemäß funktioniert<br>
