---
title: "Zurücksetzen des Truststore in AEM"
...
# Zurücksetzen des Truststore in AEM

## Beschreibung


TrustStore-Fehler können nicht abgerufen werden, werden im Protokoll angezeigt.
...
1. Öffnen <b>CRX/DE</b> als Admin-Benutzer.

2. Knoten löschen `/etc/truststore/truststore.p12`.

3. Klicken <b>[!UICONTROL Alle speichern]</b>.
