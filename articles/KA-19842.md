...
Bei dem Versuch, &quot;[!UICONTROL Quick Publish]&quot; ein Asset, werden die folgenden Fehler in `error.log` 1.

Wie im Fehler erwähnt, ist das Problem hier *`javax.jcr.ValueFormatException: cq:tags = value is single-valued`*

Gemäß 2 `cq:tags` -Eigenschaft ist ein &quot;String-Array&quot;, also sollte es sich um eine Eigenschaft mit mehreren Werten handeln, während es in diesem Fall vom Typ String war.
