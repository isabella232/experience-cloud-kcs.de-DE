...
<br>Erfahren Sie, wie Sie den SMPP-Traffic mit Wireshark analysieren.<br><br><br><br><br>Einführung<br><br><br><br> <br><br>
...
<br><br>Erfassen des Netzwerk-Traffics ohne Wireshark<br><br><br><br><br><br>
Wenn Sie keinen direkten Zugriff auf den Computer haben, kann es erforderlich sein, mithilfe von Befehlszeilen-Tools wie *tcpdump*. Wenn Sie bereits den TCP-Port der Verbindung kennen, stellen Sie den richtigen Filter ein, um zu vermeiden, dass der gesamte Traffic erfasst wird. Hier finden Sie eine Beispiel-tcpdump-Befehlszeile zum Erfassen von Port 12345 bis <b>outfile.pcap</b>:
...
<br><br>Wireshark-Handhabung<br><br><br><br> <br><br><br><br>
...
Aufgrund der Natur von TCP als Stream-Protokoll kann ein TCP-Paket mehr als eine PDU enthalten, und PDUs können über 2 oder mehr TCP-Pakete umfassen. Wireshark wird PDUs korrekt zusammenstellen, sodass sie für den Wireshark-Benutzer größtenteils transparent sind.
...
Um herauszufinden, ob eine short_message eine UDH enthält, überprüfen Sie die Bits 6 und 7 von esm_class (siehe Abschnitt 5.2.12 der Spezifikation). Wireshark analysiert UDH in der Benutzeroberfläche und gibt genaue Informationen.
...
Wenn der Empfänger gebunden ist, kann SMS-C jederzeit SR senden. Der SR wird mit einer DELIVER_SM-PDU mit Bits 2-5 von *esm_class*gesetzt.
