...
Ich möchte, dass der `s_sq`-Cookie nicht mehr ausgegeben wird, aber ich weiß nicht, wie man das macht.
...
Deaktivieren Sie „[!UICONTROL ClickMap aktivieren]“, wenn Sie ClickMap in der [!UICONTROL Linktracking]-Einstellung der Adobe Analytics-Erweiterung im Adobe Experience Platform-Tag aktiviert haben.
