...
<b>Problem/Symptome</b><br><br>Wenn Sie versuchen, DNS zu konfigurieren, wie z. B. beschrieben in [https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/custom-domain-names/configure-dns-settings.html?lang=en](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/custom-domain-names/configure-dns-settings.html?lang=en), erhalten Sie die Fehler im www-Datensatz. <br><br>
...
<br><br>Bei Verwendung von `dig` -Befehl für die Domäne gibt es fehlende Einträge für den www-Eintrag 1.<br><br><br><br>
