...
Ab dem 31. März 2021 wird die ältere Version des Binärprotokolls nicht mehr vom Push-Benachrichtigungsdienst von Apple (Apple Push Notification service, APNs) unterstützt. [Weitere Informationen](https://developer.apple.com/news/?id=c88acm2b).
...
Überprüfen [Build-Nummer des Campaign Classic](https://experienceleague.adobe.com/docs/campaign-classic/using/getting-started/starting-with-adobe-campaign/launching-adobe-campaign.html?lang=de#getting-your-campaign-version) auf allen Instanzen.
