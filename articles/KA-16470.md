---
title: "Audience Manager zur Kampagne"
...
2. Die Synchronisierung der CRM-Datenbank mit dem Campaign-Kunden muss einen Prozess einrichten, bei dem die CRM-Daten an Campaign gesendet werden. Die mindestens zu synchronisierenden Felder sind die E-Mail-Adresse CRM_ID .
...
Der für AAM erstellte sFTP muss mit Adobe Campaign konfiguriert werden, damit Campaign Segmente per Push an AAM abrufen kann. Die sFTP-Anmeldedaten werden Ihnen von der Kundenunterstützung der Adobe oder Ihrem Adobe-Support-Mitarbeiter zur Verfügung gestellt. Während der Bereitstellung werden sowohl FTP-In- als auch FTP-out-Orte bereitgestellt, die von Kampagnen verwendet werden, um Zielgruppen an AAM und Onboard-Segmente von AAM zu Kampagne zu senden.
...
6. &#x200B; &#x200B; &#x200B; &#x200B; &#x200B; Erstellen Sie die Datenquellen und Ziele mit.
...
Anschließend erfassen wir auch das &quot;Kauf&quot;-Ereignis in Analytics auf der Dankeseite:
...
An dieser Stelle können wir unsere Kunden verfolgen und in Audience Manager Segmente erstellen. Außerdem haben wir zugesichert, dass sowohl Audience Manager als auch Campaign die Benutzer mit derselben CRM_ID erfassen.

9. &#x200B; &#x200B; &#x200B; &#x200B; &#x200B; Erstellen von Segmenten in Abhängigkeit vom Benutzerverhalten Erstellen Sie dann die folgenden Eigenschaften: &quot;Hat nach Winter gesucht&quot;:
...
10. &#x200B; &#x200B; &#x200B; &#x200B; &#x200B; Push the segment to Campaign Um eine AMC-Zielgruppe für Campaign freizugeben, muss die Konfiguration in Adobe Campaign durchgeführt werden, sobald das Segment in erstellt wurde. Erstellen Sie zunächst eine freigegebene Zielgruppe in Adobe Campaign und wählen Sie das AMC-Segment aus der Segmentliste aus. Innerhalb der Kampagne müssen zwei gemeinsam genutzte Zielgruppen basierend auf der MID und der Declared ID erstellt werden. Nach Abschluss der Konfiguration können die Segmente den entsprechenden Zielen in AAM automatisch zugeordnet werden.
...
11. Freigeben einer Kampagnenzielgruppe für AAM über AMC Um eine Kampagnenzielgruppe für AAM über AMC freizugeben, ist die folgende Konfiguration in Adobe Campaign erforderlich. Wählen Sie in der Kampagnen-Benutzeroberfläche unter der Menüoption Administration die Option Technische Workflows für die Produktion aus. Klicken Sie auf neue technische Workflows, ziehen Sie die Abfrage, aktualisieren Sie die freigegebene Zielgruppe und beenden Sie dann das Ende.
...
Erstellen Sie in der Kampagne zunächst eine Liste basierend auf einer Audience. Dies befindet sich in &quot;lists&quot;:
...
Im Popup-Fenster können Sie jetzt eine Marketing Cloud-Zielgruppe auswählen. Wählen Sie &quot;search_for_winter_did_not-buy&quot;:
...
Möglicherweise haben Sie sich nicht mit Ihrer Adobe ID für Campaign angemeldet. Wenn Sie sich mit Ihrer Adobe ID angemeldet haben, stellen Sie sicher, dass Sie zum Produkt Zielgruppenbibliothek in der Benutzeroberfläche von Marketing Cloud Enterprise Console hinzugefügt wurden.
...
3. Ordnen Sie die Segmente niemals über die AAM UI dem Kampagnenziel zu &#x200B;
